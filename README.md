...
> <p name="en" id="en">Due to incidents of extraction of my code for commercial purposes without my concent, I have moved automation repositories to private. Unauthorized use of my scripts is prohibited. If you have any professional inquiries, please contact me directly through LinkedIn.</p>
>
...
> <p name="ru" id="ru">В связи с неоднократными случаями несанкционированного использования и эксплуатации моих проектов без указания авторства или поддержки, все проекты по автоматизации перемещены в приватные репозитории. Если вы менеджер по найму или имеете предложение о работе, пожалуйста, свяжитесь со мной через мой профиль LinkedIn.</p>
>
